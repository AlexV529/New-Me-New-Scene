...
In my 2025 recap I put Games and school because those were my focus I would worry about school than be lazy and play games.

## Description of 2026 goals

I included school, sleep, study. and games in my 2026 goals because I dont get a lot of sleep and I should. I need to focus more on school this semester because it is harder.
## Scene API Usage

I used various scene API methods in my code to positions my images and text to look good. I used playscene and drawscene to make and play different scenes. I used clear to erase the original scene for the new one to not overlap. I used pause to give time to read the recap and images for the first scene.
